...
M.onTerminalOpen = function(args)
  local name = editor_use_case.current_path(args.buf)
...
M.onTerminalOutput = function(args)
  chatbot_use_case.scroll_to_bottom(args.buf)
end

M.onTerminalDestroy = function(args)
  logger_use_case.debug({
    module = "hooks/terminal",
    func = "onTerminalDestroy",
  })
