...
local M = {
	...
	review = function()
		return function()
			versior_usecase.review()
		end
	end,

	pull_request = function()
		return function()
			versior_usecase.pull_request()
		end
	end,

	pull_requests = function(opts)
		return function()
			versior_usecase.pull_requests(opts)
		end
	end,

	reload_pull_request = function()
		return function()
			versior_usecase.reload_pull_request()
		end
	end,

	notifications = function(opts)
		return function()
			versior_usecase.notifications(opts)
		end
	end,
}
