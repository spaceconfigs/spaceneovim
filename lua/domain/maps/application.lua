...
local changer = require("domain.contracts.controller_registry").changer()
local chatbot = require("domain.contracts.controller_registry").chatbot()
local documentation = require("domain.contracts.controller_registry").documentation()
local todo = require("domain.contracts.controller_registry").todo()
---@return KeyBind[]
return function()
  ---@type KeyBind[]
