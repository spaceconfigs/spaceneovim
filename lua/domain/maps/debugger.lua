...
local debugger_content = {
	...
	{ key = "i", description = "Step in", method = debugger_controller.step_into() },
	{ key = "o", description = "Step out", method = debugger_controller.step_out() },
	{ key = "s", description = "Step over", method = debugger_controller.step_over() },
	-- { key = "u", description = "Go up", method = debugger_controller.step_back() },
...
local context_content = {
	...
	{ key = "Sd", description = "Go down in stacktrace", method = debugger_controller.go_down() },
	{ key = "Su", description = "Go up in stacktrace", method = debugger_controller.go_up() },
}
