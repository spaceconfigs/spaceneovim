...
local linenumber = require("domain.contracts.controller_registry").linenumber()
local statusline = require("domain.contracts.controller_registry").statusline()
local toggler = require("domain.contracts.controller_registry").toggler()
---@return KeyBind[]
return function()
	---@type KeyBind[]
