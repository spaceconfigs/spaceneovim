...
local database = require("domain.contracts.registry").database()
local diagnostic = require("domain.contracts.registry").diagnostic()
local formatter = require("domain.contracts.registry").formatter()
local hover = require("domain.contracts.registry").hover()
local lsp = require("domain.contracts.registry").lsp()
local notebook = require("domain.contracts.registry").notebook()
local noter = require("domain.contracts.registry").noter()
local outline = require("domain.contracts.registry").outline()
local pomodoro = require("domain.contracts.registry").pomodoro()
local rest = require("domain.contracts.registry").rest()
local screenshot = require("domain.contracts.registry").screenshot()
local searcher = require("domain.contracts.registry").searcher()
local tester = require("domain.contracts.registry").tester()
---@return KeyBind[]
return function()
	---@type KeyBind[]
	local test_content = {
