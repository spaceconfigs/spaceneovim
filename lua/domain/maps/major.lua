...
local jumpto_content = {
	...
	{ key = "Gd", description = "[d]definition", method = lsp_controller.definition({ type = "remote" }) },
	{ key = "Gi", description = "[i]mplementation", method = lsp_controller.implementation({ type = "remote" }) },
	...
	{ key = "Gr", description = "[r]eferences", method = lsp_controller.references({ type = "remote" }) },
	...
	{ key = "Gt", description = "[t]ype-definition", method = lsp_controller.typedefinition({ type = "remote" }) },
}

local goto_content = {
	{ key = "g", description = "Goto" },
	{ key = "gd", description = "[d]definition", method = lsp_controller.definition() },
	{ key = "gi", description = "[i]mplementation", method = lsp_controller.implementation() },
	{ key = "gk", description = "Documentation ([k])", method = lsp_controller.show_documentation() },
	{ key = "gK", description = "Signature ([K])", method = lsp_controller.show_signature() },
	{ key = "gr", description = "[r]eferences", method = lsp_controller.references() },
	{ key = "gt", description = "[t]ype-definition", method = lsp_controller.typedefinition() },
}

local help_content = {
	{ key = "h", description = "Help" },
	{ key = "hh", description = "Show [h]over", method = hover_controller.toggle() },
	{ key = "hH", description = "Show signature ([H])", method = lsp_controller.signature_help() },
}
...
local insert_content = {
	{ key = "i", mode = { "n", "x" }, description = "Insert" },
	{
		...
		method = screenshot_controller.copy({ type = "select" }),
	},
	{
		key = "iDH",
		mode = "x",
		description = "Save [H]ighlight",
		method = screenshot_controller.save({ type = "select" }),
	},
	{
		key = "iDs",
		mode = "x",
		description = "Take [s]screenshot",
		method = screenshot_controller.copy(),
	},
	{
		key = "iDS",
		mode = "x",
		description = "Save [S]screenshot",
		method = screenshot_controller.save(),
	},
	{
		key = "iDt",
		mode = "x",
		description = "[t]ext screenshot",
		method = screenshot_controller.copy({ type = "text" }),
	},
...
local major_content = {
	{ key = "a", description = "Code [a]ction", method = lsp_controller.code_action() },
