...
return function()
  ...
  local content = {
    ...
    { key = "h", description = "MCPHub",              method = chatbot.open_hub() },
    { key = "l", description = "Select model",        method = chatbot.select_model() },
    { key = "p", mode = { "n", "v" },                 description = "Send prompt",            method = chatbot.send() },
    { key = "P", mode = { "n" },                      description = "Send word under cursor", method = chatbot.add_word() },
    { key = "P", mode = { "v" },                      description = "Send selection text",    method = chatbot.add_selection() },
