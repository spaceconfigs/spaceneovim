...
return function()
  ...
  local grep_input_content = {
    ...
    { key = "Gp", description = "Grep in project",    method = workspace.grep_input() },
  }
  ...
  local search_content = {
    ...
    {
      key = "D",
      description = "Directory w/ input",
      method = searcher.search_hover({ location = "directory" }),
    },
    { key = "l", description = "Resume (last)",   method = searcher.resume() },
    {
      key = "p",
    ...
    { key = "s", description = "Text (search)",   method = searcher.search({ in_live = true }) },
    { key = "S", description = "Search w/ input", method = searcher.search_hover() },
  }
