...
local window_content = {
  ...
  { key = "]", description = "Shrink width (])",         method = window_controller.resize({ axis = "width", delta = 5 }) },
  { key = "[", description = "Expand width ([)",         method = window_controller.resize({ axis = "width", delta = -5 }) },
  { key = "+", description = "Shrink height (+)",        method = window_controller.resize({ axis = "height", delta = 5 }) },
  { key = "-", description = "Expand height (-)",        method = window_controller.resize({ axis = "height", delta = -5 }) },
