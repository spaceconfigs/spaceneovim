...
local default_map = {
	...
	{ key = "1", description = "Window 1", method = window_controller.go_to(1) },
	{ key = "2", description = "Window 2", method = window_controller.go_to(2) },
	{ key = "3", description = "Window 3", method = window_controller.go_to(3) },
	{ key = "4", description = "Window 4", method = window_controller.go_to(4) },
	{ key = "5", description = "Window 5", method = window_controller.go_to(5) },
	{ key = "6", description = "Window 6", method = window_controller.go_to(6) },
	{ key = "7", description = "Window 7", method = window_controller.go_to(7) },
	{ key = "8", description = "Window 8", method = window_controller.go_to(8) },
	{ key = "9", description = "Window 9", method = window_controller.go_to(9) },
