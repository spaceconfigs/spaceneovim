...
local unprefixed_content = {
	...
	{ key = "<M-j>", description = "Drag line down", method = editor_controller.drag_down({ mode = "normal" }) },
	{ key = "<M-k>", description = "Drag line up", method = editor_controller.drag_up({ mode = "normal" }) },
	{ key = "{", mode = { "n", "v" }, description = "Next paragraph", method = editor_controller.next_paragraph() },
	{ key = "}", mode = { "n", "v" }, description = "Previous paragraph", method = editor_controller.previous_paragraph() },
	{ key = "p", mode = { "v" }, description = "Past", method = editor_controller.paste_before() },
	{ key = "P", mode = { "v" }, description = "Past", method = editor_controller.paste_after() },
	{
		key = "<M-j>",
		mode = "v",
		description = "Drag line down",
		method = editor_controller.drag_down({ mode = "visual" }),
	},
	{
		key = "<M-k>",
		mode = "v",
		description = "Drag line up",
		method = editor_controller.drag_up({ mode = "visual" }),
	},
	{
		key = "<M-j>",
		mode = "i",
		description = "Drag line down",
		method = editor_controller.drag_down({ mode = "insert" }),
	},
	{
		key = "<M-k>",
		mode = "i",
		description = "Drag line up",
		method = editor_controller.drag_up({ mode = "insert" }),
	},
	{
		key = "<Esc>",
		mode = "t",
	...
	{ key = "q", mode = { "n" }, description = "", method = editor_controller.noop() },
}
