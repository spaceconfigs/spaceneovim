...
--- here (require("domain.contracts.controller_registry").<name>()) instead of importing
--- presentation controllers. Mirrors application/ports/adapter_registry.lua (AdapterRegistry).
...
---@field keymapper fun(): KeymapperContract
